...
| Section | Title | Line |
|---|---|---|
| §0 | Purpose and conventions | 72 |
| §1 | Rules and SGF | 93 |
| &nbsp;&nbsp;§1.1 | Rule sets | 95 |
| &nbsp;&nbsp;§1.2 | New games and handicap | 109 |
| &nbsp;&nbsp;§1.3 | Legality | 117 |
| &nbsp;&nbsp;§1.4 | Game model | 130 |
| &nbsp;&nbsp;§1.5 | SGF | 140 |
| §2 | Engine protocols | 153 |
| &nbsp;&nbsp;§2.1 | Transport | 155 |
| &nbsp;&nbsp;§2.2 | Shared analysis shape | 162 |
| &nbsp;&nbsp;§2.3 | GTP | 174 |
| &nbsp;&nbsp;§2.4 | KataGo analysis engine | 192 |
| &nbsp;&nbsp;§2.5 | handol-mux human-policy surface | 201 |
| &nbsp;&nbsp;§2.6 | Fake engine | 240 |
| §3 | Session and boards | 246 |
| &nbsp;&nbsp;§3.1 | Spaces | 248 |
| &nbsp;&nbsp;§3.2 | Engine play and analysis | 254 |
| &nbsp;&nbsp;§3.3 | Boards | 271 |
| &nbsp;&nbsp;§3.4 | Engine settings | 283 |
| &nbsp;&nbsp;§3.5 | Final score and console | 288 |
| &nbsp;&nbsp;§3.6 | Traffic log | 293 |
| &nbsp;&nbsp;§3.7 | Keyboard shortcuts | 297 |
| §4 | WebSocket protocol | 302 |
| &nbsp;&nbsp;§4.1 | Browser → server | 306 |
| &nbsp;&nbsp;§4.2 | Server → browser | 330 |
| §5 | HTTP routes | 344 |
| §6 | Launch modes and policies | 362 |
| &nbsp;&nbsp;§6.1 | The rule | 364 |
| &nbsp;&nbsp;§6.2 | Identity policy | 381 |
| &nbsp;&nbsp;§6.3 | Engine-address policy | 387 |
| &nbsp;&nbsp;§6.4 | Storage policy | 401 |
| §7 | Authentication and security | 407 |
| &nbsp;&nbsp;§7.1 | Password accounts (server) | 409 |
| &nbsp;&nbsp;§7.2 | Sessions (server) | 417 |
| &nbsp;&nbsp;§7.3 | SSO header (server) | 425 |
| &nbsp;&nbsp;§7.4 | Origin and Host rules (both modes) | 433 |
| &nbsp;&nbsp;§7.5 | Response headers and rendering | 447 |
| &nbsp;&nbsp;§7.6 | Limits (both modes) | 454 |
| &nbsp;&nbsp;§7.7 | Engine addresses and the console (server) | 468 |
| &nbsp;&nbsp;§7.8 | Isolation and idle release (server) | 478 |
| &nbsp;&nbsp;§7.9 | Fail-closed startup (server) | 484 |
| §8 | Persistence | 490 |
| &nbsp;&nbsp;§8.1 | Snapshot format (version 1) | 492 |
| &nbsp;&nbsp;§8.2 | Saving | 511 |
| &nbsp;&nbsp;§8.3 | Local state file | 516 |
| &nbsp;&nbsp;§8.4 | Server database | 525 |
| &nbsp;&nbsp;§8.5 | Browser storage | 530 |
| §9 | Command line | 534 |
| §10 | Configuration (server) | 549 |
| §11 | Feature inventory | 569 |
| &nbsp;&nbsp;§11.1 | Baseline features | 575 |
| &nbsp;&nbsp;§11.2 | New in this rebuild | 613 |
| §12 | Non-goals | 629 |
<!-- TOC END -->
...
- **Duplicate** copies the active board — position, cursor and human settings — inserts the copy
  ...
  name, ignores an empty one and keeps at most 40 characters. **Delete** removes a board, switching
...
identity (§6.2). Browser-originated requests obey the origin rules of §7.4. Every response carries
the headers of §7.5.
...
After 5 failed attempts for the same (peer address, name) within 10 minutes, further attempts are
...
socket address: forwarded-for headers never replace it. SSO and password accounts with the same
...
- A WebSocket handshake or a state-changing request (`POST`) that carries an `Origin` header is
  ...
  close code `4401` for the WebSocket and `403` for HTTP. Requests without `Origin` (non-browser
...
Out-of-range numbers are clamped; oversize input is refused with an error.
...
| `GOWUI_TRUSTED_PROXIES` | comma-separated IPs/CIDRs allowed to set that header; required for `header` | — |
...
| B7 | Ownership overlay | §2.3, §2.4 | both | pending |
...
| N9 | `/healthz` and container deployment | §5 | server | pending |
